...
public class ChipConfiguration {
    ...
    private final boolean mChipUnderlined;
    ...
    ChipConfiguration(int chipSpacing,
                      ...
                      int maxAvailableWidth, boolean chipUnderlined) {
        ...
        mChipUnderlined = chipUnderlined;
    }
    ...
    public boolean isChipUnderlined() {
        return mChipUnderlined;
    }
}
